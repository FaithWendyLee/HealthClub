			...
			<div id="left_content">
			  ...
			  $('#addUserBtn').show();addUser()"> 家庭
						...
						<div class="control-group">
							...
							<div class="controls">
								<select name="sex">
									...
									<option id = "female" selected="selected">女</option>
								</select>
							</div>
						</div>
						<div class="control-group">
					...
					<div class="control-group" id="buttons">
						<div class="controls">
							<button id="addUserBtn" type="button" class="btn inline"
								onclick="addUser()">增加用户</button>
